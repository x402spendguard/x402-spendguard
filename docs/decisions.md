...
**Deferred (unchanged gate).** The one allowed micro-payment that actually settles on a testnet — the only part that moves value and needs a funded key — remains the next milestone. Until it exists: do not place this in front of a funded wallet.
